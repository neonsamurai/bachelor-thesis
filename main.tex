...
\ctparttext{Preamble für Einleitung} % Text on the Part 1 page describing  the content in Part 1
\part{Einleitung} % First part of the thesis
\include{Chapters/01-Einleitung.tex}
\include{Chapters/02-Aufgabenstellung.tex}
\include{Chapters/03-FachlichesUmfeld.tex}
...
\include{Chapters/04-Loesungsansaetze.tex}
\include{Chapters/05-Pflichtenheft.tex}
\include{Chapters/06-Systementwurf.tex}
\include{Chapters/07-Implementierung.tex}
\cleardoublepage % Empty page before the start of the next part
...
\include{Chapters/08-Bedienungsanleitung.tex}
\include{Chapters/09-ZusammenfassungAusblick.tex}
\cleardoublepage % Empty page before the start of the next part
...
\include{Chapters/10A-Listings.tex} % Appendix A
