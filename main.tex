...
\ctparttext{Es folgt die Präsentation der Ergebnisse dieser Arbeit. Eine kleine
Bedienungsanleitung soll den Einstieg erleichtern. Im Anschluß wird der Ausgang
der Arbeit bewertet und ein Ausblick auf zukünftige Implementierungsziele
gegeben.}
...
\cleardoublepage\include{FrontBackMatter/Software} % Software used to produce the thesis and implementation
